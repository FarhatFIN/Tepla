    ...
    <aside className="flex h-full flex-col bg-[var(--bg-sidebar)] transition-colors">
      ...
      <header className="flex items-center justify-between border-b border-[var(--border)] px-4 py-2.5">
        <div className="flex items-center gap-2">
          <h1 className="text-base font-bold text-[var(--text-primary)]">Startup Mode</h1>
        </div>
      ...
      <div className="mx-3 mt-3 mb-2 rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold text-[var(--accent)]">Investor-demo quality pass</span>
        </div>
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-[var(--text-tertiary)]">Blocking</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 pb-2">
        <div className="flex items-center gap-2 rounded-xl bg-[var(--bg-input)] px-3 py-2">
          ...
          <input type="text" placeholder="Search chats, channels and more..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full bg-transparent text-sm text-[var(--text-primary)] placeholder-[var(--text-tertiary)] outline-none" />
          {searchQuery && (
