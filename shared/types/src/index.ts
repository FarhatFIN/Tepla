...
export type StickerPackId = string & { readonly __brand: 'StickerPackId' };
export type StickerId = string & { readonly __brand: 'StickerId' };
export type ThreadId = string & { readonly __brand: 'ThreadId' };
export type FolderId = string & { readonly __brand: 'FolderId' };
export type WebAppId = string & { readonly __brand: 'WebAppId' };
...
export const DEFAULT_MEMBER_PERMISSIONS: ChatPermissions = {
...
export const ADMIN_PERMISSIONS: ChatPermissions = {
  canSendMessages: true,
  canSendMedia: true,
  canSendStickers: true,
  canSendPolls: true,
...
export type SupportedLanguage =
  | 'en' | 'ru' | 'uk' | 'es' | 'fr' | 'de' | 'it' | 'pt' | 'zh'
  | 'ja' | 'ko' | 'ar' | 'hi' | 'tr' | 'pl' | 'nl' | 'sv' | 'da'
  | 'fi' | 'no' | 'cs' | 'ro' | 'hu' | 'el' | 'th' | 'vi' | 'id'
  | 'ms' | 'he' | 'fa' | 'bg' | 'hr' | 'sk' | 'sl' | 'et' | 'lv'
  | 'lt' | 'sr' | 'ka' | 'az' | 'kk' | 'uz';
